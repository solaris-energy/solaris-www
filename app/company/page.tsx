    ...
    <>
      <main id="main" className="relative isolate">
        <section className="mx-auto max-w-[1440px] px-6 pt-24 pb-12 md:px-12 xl:px-16">
          ...
          <h1
            className="mt-4 max-w-[22ch] text-[clamp(2.5rem,5.5vw,4rem)] leading-[1.05] font-bold tracking-[-0.02em] text-balance"
        ...
        <section className="mx-auto max-w-[1440px] px-6 py-12 md:px-12 xl:px-16">
          <div className="grid grid-cols-1 gap-12 border-t border-[color:var(--color-bg-edge)] pt-12 md:grid-cols-[1fr_1.4fr]">
            <p
              className="text-[11px] tracking-[0.12em] text-[color:var(--color-fg-tertiary)] uppercase"
              style={{ fontFamily: "var(--font-mono)" }}
            >
              Mission
            </p>
            <p className="max-w-[60ch] text-[20px] leading-[1.55] text-[color:var(--color-fg-primary)]">
              ...
              solar. We replace the screenshot-and-Excel proposal stack with a versioned
              workspace that takes a satellite tile and returns a bankable proposal in
              under thirty minutes. We are based in Casablanca and hire across MENA and
              the EU. We ship on commodity hardware, default to EU hosting, and publish
              the spec for every contract we serve.
            </p>
          </div>
        </section>
        ...
        >
          <div className="grid grid-cols-1 gap-12 border-t border-[color:var(--color-bg-edge)] pt-12 md:grid-cols-[1fr_1.4fr]">
            ...
            <p className="max-w-[60ch] text-[16px] leading-[1.6] text-[color:var(--color-fg-secondary)]">
              We are not hiring at scale. We are hiring two senior engineers and one
              solar engineer who can defend a yield model in a permit review. Comp
              ranges and scope on request.{" "}
              <Link
