...
export default function NotFound() {
  return (
    ...
    >
      <p className="font-mono text-xs tracking-[0.08em] text-[color:var(--color-fg-tertiary)] uppercase">
        404 / Not found
      </p>
      <h1
        className="mt-4 text-[clamp(2rem,4vw,3rem)] leading-[1.1] font-bold"
        style={{ fontFamily: "var(--font-display)" }}
      >
        No signal at this coordinate.
      </h1>
      <p className="mt-4 max-w-[56ch] text-[color:var(--color-fg-secondary)]">
        The page you requested does not exist. It may have moved, or never existed in
        the first place.
      </p>
      <Link
        href="/"
