    ...
    <>
      <main id="main" className="relative isolate">
        ...
        <section className="relative mx-auto flex max-w-[1440px] flex-col px-6 pt-24 pb-12 md:px-12 xl:px-16">
          <p
            className="font-mono text-xs tracking-[0.08em] text-[color:var(--color-fg-tertiary)] uppercase"
          ...
          <h1
            className="mt-6 max-w-[18ch] text-[clamp(2.75rem,6vw,4.5rem)] leading-[1.05] font-bold tracking-[-0.02em] text-balance"
          ...
          <dl className="mt-16 grid grid-cols-2 gap-x-8 gap-y-6 border-t border-[color:var(--color-bg-edge)] pt-8 md:grid-cols-4">
            {[
              ...
              <div key={m.l}>
                ...
                <dd className="mt-1 font-mono text-[12px] tracking-[0.06em] text-[color:var(--color-fg-tertiary)] uppercase">
                  {m.l}
                </dd>
              </div>
            ))}
          ...
          <p className="mt-8 max-w-[56ch] font-mono text-[12px] text-[color:var(--color-fg-tertiary)]">
            Pilot figures from internal benchmark on flat-roof warehouses, 200 kWp to 2
            MWp. Production SLAs published per tier.
          </p>
        </section>
